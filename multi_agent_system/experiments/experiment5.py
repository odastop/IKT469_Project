# Experiment 5: Ablation without source validation.
# No SelectorAgent and no AdderAgent.
# The answerer receives the top reranked documents directly.
...
"""
    ...
    fallback = [question]
    # Add entity-based query expansions
...
def run_pipeline(
    ...
    # Ablation: remove source validation.
    # No SelectorAgent and no AdderAgent.
    # The answerer receives the top reranked documents directly.
    ...
    if verbose:
        ...
        print("\nSELECTED EVIDENCE")
        print("Source validation disabled; using top reranked documents directly.")
        for d in selected:
...
# Normalize answers before evaluation
...
# Compute supporting-title recall
